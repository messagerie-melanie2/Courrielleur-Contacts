...
function isGroupdavDirectory(abURI) {
  ...
  if (!abURI
      ...
      || "moz-abmdbdirectory://history.mab"==abURI  //kCollectedAddressbookUri
      || !abURI.startsWith("moz-abmdbdirectory://")) {
    return false;
  }
...
GroupDAVListAttributes.prototype = {
    _getCharPref: function(key) {
      ...
      if (!this.mPrefs.prefHasUserValue(this.prefPath + "." + key))
        return null;
    ...
    get versionprev() {
        return this._getCharPref("versionprev");
    },
    set versionprev(oldVersion) {
        this._setCharPref("versionprev", oldVersion);
    },
